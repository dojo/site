...
const mockMarkupOutput = v('div', { key: 'compiled-20' }, [
...
`,
	...
	`
`,
	v('h2', { key: 'compiled-16' }, ['CodeSandbox Embed']),
	`
`,
	w(
		'docs-codesandbox',
		{ url: 'https://codesandbox.io/embed/github/dojo/examples/tree/master/todo-mvc', key: 'compiled-17' },
		[]
	),
	`
`,
	v('h2', { key: 'compiled-18' }, ['CodeBlock']),
	`
`,
	w('docs-codeblock', {}, ['some content from a file'])
]);

const mockMarkupStringOutput = `<h1>Another Tutorial</h1>
<p><a href=\"https://example.com/\" target=\"_blank\">absolute link to another page!</a></p>
<p><a href=\"./other-page\">link to another page!</a></p>
<p><a href=\"./other-page\">link to another page with anchor!</a></p>
<p>A github link</p>
<p><a href=\"https://github.com/dojo/framework/pull/1\" target=\"_blank\">#1</a></p>
<h2>Aside</h2>
<Aside title=\"Another tutorial\"><p>I am another tutorial</p></Aside>
<h2>CodeSandbox Embed</h2>
<CodeSandbox url=\"https://codesandbox.io/embed/github/dojo/examples/tree/master/todo-mvc\"></CodeSandbox>
<h2>CodeBlock</h2>
<CodeBlock path=\"tutorial-2-finished/src/widgets/App.tsx\" language=\"tsx\"></CodeBlock>`;
